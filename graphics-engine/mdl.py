...
def p_command_cone(p):
    ...
    # coordinate system (symbol at end)
    if len(p) == arg_start + 6:
        cmd['cs'] = p[arg_start + 5]
...
def p_command_circle(p):
    """command : CIRCLE NUMBER NUMBER NUMBER NUMBER
               | CIRCLE SYMBOL NUMBER NUMBER NUMBER NUMBER
               | CIRCLE NUMBER NUMBER NUMBER NUMBER SYMBOL
               | CIRCLE SYMBOL NUMBER NUMBER NUMBER NUMBER SYMBOL"""
    cmd = {'op' : p[1], 'constants' : None, 'cs' : None, 'args':[]}
    arg_start = 2
    if isinstance(p[2], str):
        cmd['constants'] = p[2]
...
def p_command_curve(p):
    """command : BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER
               | BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER SYMBOL
               | BEZIER SYMBOL NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER
               | HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER
               | HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER SYMBOL
               | HERMITE SYMBOL NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER"""
    ...
    if len(p) > arg_start+12: #isinstance(p[-1], str):
        cmd['cs0'] = p[arg_start+12]
    commands.append(cmd)
...
def p_command_vary(p):
    """command : VARY SYMBOL NUMBER NUMBER NUMBER NUMBER
               ...
               | VARY SYMBOL NUMBER NUMBER NUMBER NUMBER SYMBOL NUMBER"""
